...
/**
 * copy and paste from  https://www.googleapis.com/books/v1/volumes?q=android&maxResults=1&startInd
 */
public const val MY_MOCKS_BOOKS_LIST: String = "{\n" +
        "  \"kind\":\"books#volumes\",\n" +
        "  \"totalItems\":395,\n" +
        "  \"items\":[\n" +
        "    {\n" +
        ...
        "        },\n" +
        "        \"language\":\"en\",\n" +
        "        \"previewLink\":\"http://books.google.pt/books?id=qKFDDAAAQBAJ&printsec=frontcover&dq=android&hl=&cd=1&source=gbs_api\",\n" +
        ...
        "        \"pdf\":{\n" +
        "          \"isAvailable\":true,\n" +
        "          \"acsTokenLink\":\"http://books.google.pt/books/download/Android-sample-pdf.acsm?id=qKFDDAAAQBAJ&format=pdf&output=acs4_fulfillment_token&dl_type=sample&source=gbs_api\"\n" +
        "        },\n" +
